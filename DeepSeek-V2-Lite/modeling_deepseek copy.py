...
class DeepseekV2MoE(nn.Module):
    ...
    def forward(self, hidden_states, vtensors=None):
        if self.first_run:
            ...
            # Prefetch the vtensor for experts predicted to be used 4 layers ahead
            # This allows the model to start loading these experts into memory in advance
            # which can reduce latency when they are actually needed
            self.vtensor.async_prefetch(predicted_experts_four_layers_ahead.tolist()) # Convert numpy array to list
